...
// const sortStudentsByScore = (array) => {
// 	return array.sort((a, b) => b["score"] - a["score"]); //내림차순(b-a), 오름차순(a-b)
// };
...
// const areAllNumbersGreaterThan = (array, target) => {
// 	return array.every((num) => num > target);
// };
...
// const countStringOccurrences = (array) => {
// 	const obj = {};
...
// const getProductsByCategory = (products, target) => {
...
// const groupByKey = (students, key) => {
// 	const obj = { A: [], B: [], C: [] };

// 	for (let student of students) {
// 		obj[student[key]].push(student);
// 	}
// 	return obj;
// };
