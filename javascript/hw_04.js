...
// const getUsersByCity = (arrays, target) => {
// 	return arrays.filter((user) => target === user["city"]);
// };
...
// const getPassOrFail = (students) => {
// 	return students["score"] >= 70 ? "Pass" : "Fail";
// };
...
// const mapArray = (numArray, callback) => {
// 	return numArray.map((array) => callback(array));
// };
...
// const extractProperty = (objArray, target) => {
// 	return objArray.map((obj) => obj[target]);
// };
