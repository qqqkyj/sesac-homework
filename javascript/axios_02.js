...
const getAllCarsResponseKeys = async () => {
	const res = await getAllCarsResponse();
...
const getSingleCartFirstProduct = async (id) => {
	const cartRes = await getSingleCart(id);
	const productRes = await getSingleProduct(cartRes["products"][0]["id"]);
