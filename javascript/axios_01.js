...
async function getAllProductsResponseKeys() {
	const res = await getAllProductsResponse();
...
const getSearchPosts = async (searchValue) => {
...
const getSearchPostsArray = async (searchValue) => {
	const res = await getSearchPosts(searchValue);
	console.log(res["posts"]);
};

// getSearchPostsArray("love");
